...
public class View extends JFrame {
    private JLabel label1=new JLabel("Selectati tipul de utilizator:",SwingConstants.CENTER);
    private JLabel emptyLabel1=new JLabel("");
    private JRadioButton button1=new JRadioButton("Administrator");
    private JRadioButton button2=new JRadioButton("Client");
    private JRadioButton button3=new JRadioButton("Angajat");
